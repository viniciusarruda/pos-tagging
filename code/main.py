...
def load_dataset(filepath, vocab_idx=None):
...
def get_matrices(dataset: list[tuple[str, str]]):
    ...
    return transition_matrix, emission_matrix, tagset, vocab_idx
...
def main():
    ...
    transition_matrix, emission_matrix, tagset, vocab_idx = get_matrices(dataset)
    ...
    dataset = load_dataset(test_filepath, vocab_idx)
    acc = evaluate(
        dataset,
        transition_matrix,
        emission_matrix,
